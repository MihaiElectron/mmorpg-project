...
- [x] Critique combat V4-D — `criticalChance` (%) / `criticalDamage` (×%, 150 = ×1.5) réutilisées et promues implemented + masteryEligible, calcul serveur dans le bloc attaque (roll RNG injectable, avant armure), auto-attaque + skills damage, physical & raw (contrat V4-D0) (2026-07-12)
