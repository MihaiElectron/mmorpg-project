...
export class AdminGateway implements OnGatewayConnection {
  ...
  async onUpdateTemplate(
    ...
    const numericAllowed = ['baseHealth', 'aggroRadius', 'baseAttack', 'baseArmor', 'fleeThresholdPct', 'patrolRadius', 'respawnDelayMs', 'killCharacterXpReward', 'healingPower', 'criticalChance', 'criticalDamage', 'accuracy', 'armorPenetrationPercent', 'strength', 'vitality', 'endurance', 'agility', 'dexterity', 'intelligence', 'wisdom', 'spirit', 'willpower', 'charisma'];
